...
Products must be returned in their original, unopened packaging with the invoice.''',
              ...
              Text(
                "How to Return",
                style: GoogleFonts.mulish(
                    color: greenColor, fontSize: 20, fontWeight: FontWeight.w700),
              ),
              Text(
...
Dropping it off at the partner pharmacy.''',
              ...
              Text(
                '''Orders cannot be canceled once confirmed. We appreciate your understanding and cooperation. For any concerns, please contact our support team at medkaro.in@gmail.com.''',
                style: GoogleFonts.mulish(
                    color: whiteColor, fontSize: 15, fontWeight: FontWeight.w300),
              ),
