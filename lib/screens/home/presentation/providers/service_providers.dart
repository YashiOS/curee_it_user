...
import 'package:cureeit_user_app/screens/home/domain/repositiries/service_repository_impl.dart';
...
final servicesProvider = FutureProvider.family<List<Service>, (String, String)>((ref, params) async {
